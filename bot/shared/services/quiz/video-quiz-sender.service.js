'use strict';
/**
 * bd-2307 — execute the render contract against the WhatsApp API.
 *
 ...
 *
 * bd-2358: putting it there was right; KEEPING the cut-off title above it was
 ...
 *
 * Uses the bd-720 hybrid: `navigateData` + `screen` pre-fills the option images
