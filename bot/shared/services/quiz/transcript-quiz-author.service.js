...
- FRACTIONS. One bar, some parts shaded, no label: "What fraction of the bar is shaded?" («تصویر میں پٹی کا کتنا حصہ رنگا ہوا ہے؟») — the options three fractions. Three bars labelled "A", "B", "C": "Which bar shows $\\frac{2}{3}$?" — the options "A", "B", "C" (every option is on the picture, so nothing is given away; the feedback says "bar A", never "option A"). Two bars of the same length, unlabelled: "Both bars are the same length. What fraction of the bar with MORE shaded is shaded?" — the stem names no fraction, so the child reads both off the picture. A grid: "What fraction of the squares are shaded?"
