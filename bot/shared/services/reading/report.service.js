...
class ReadingReportService {
  ...
  static _drawHeader(doc, reportData, performance, yPos) {
    ...
    try {
      const logoPath = path.join(__dirname, '../../../marketing/NIETE White.jpg');
    ...
    doc.fontSize(10)
       ...
       .font('Helvetica')
       .text('Student Reading Fluency Evaluation powered by NIETE', 145, yPos + 35);
  ...
  static _drawFooter(doc, yPos) {
    doc.fontSize(7)
       .fillColor(this.COLORS.secondary)
       .text(`Generated by NIETE • Supporting teachers everywhere • ${new Date().toLocaleDateString()}`, 50, yPos, {
         width: 495,
         align: 'center'
       });
  }
