...
function hotsObserveAnalysisPrompt(transcript, metadata = {}) {
  ...
  return (
    ...
    // «احترامی جمع» (کرتے ہیں، پڑھاتے ہیں) is the masculine, not a neutral
    // form — the same rule as config/gender-neutral-address URDU_THIRD_PERSON_RULE.
    '- استاد مرد بھی ہو سکتے ہیں اور خاتون بھی — استاد کا ذکر ہمیشہ صنفی طور پر غیر جانب دار رکھیں: ' +
    'اسم والا جملہ (استاد کی خواہش ہے کہ…، استاد کا سوال)، «نے» والا ماضی (استاد نے پوچھا، استاد نے بچوں کو گروپ میں بٹھایا) ' +
    'یا غیر شخصی انداز (سوال پوچھا گیا، یہ آزمایا جا سکتا ہے) استعمال کریں؛ ' +
    'نہ مذکر (کرتے ہیں، پڑھاتے ہیں، چاہتے ہیں، کریں گے) نہ مؤنث (کرتی ہیں، پڑھاتی ہیں، چاہتی ہیں، کریں گی) لکھیں۔\n' +
