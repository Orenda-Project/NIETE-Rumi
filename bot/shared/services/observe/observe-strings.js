...
const STRINGS = {
  sw: {
    ...
    teacher_action_intro: '{school}\n\nOngeza mwalimu, mwondoe mmoja, au hariri maelezo. Kumwongeza mwalimu aliye shule nyingine kunamhamishia hapa.',
  ...
  ur: {
    ...
    debrief_choice_body: 'اگلا قدم: استاد کے ساتھ تعمیری گفتگو (ڈی بریف)۔ 🌱\n\nمیں آپ کے لیے مختصر گفتگو کا خاکہ تیار کروں گی — سچی تعریف، غور کا ایک سوال، اور بہتری کی صرف ایک بات۔ ابھی بات کریں یا بعد میں؟',
    ...
    debrief_record_instruction:
      'استاد کے پاس ہوں تو: WhatsApp کا وائس ریکارڈر 🎙 کھول کر اپنی پوری گفتگو ریکارڈ کریں — خاکہ اوپر موجود رہے گا۔\n\nیہ ریکارڈنگ صرف آپ کے لیے ہے: میں سن کر آپ کو بطور کوچ بڑھنے میں مدد دوں گی۔ یہ استاد تک کبھی نہیں پہنچے گی۔',
    ...
    teacher_action_intro: '{school}\n\nیہاں استاد شامل کریں، کسی کو ہٹائیں، یا تفصیل درست کریں۔ جو استاد پہلے سے کسی اور اسکول میں ہیں، انہیں شامل کرنے سے وہ یہاں منتقل ہو جاتے ہیں۔',
    ...
    leader_registered_welcome:
      'بطور اسکول لیڈر آپ کی رجسٹریشن ہو گئی۔ 🌱 جب کسی استاد کی کلاس دیکھنے جائیں تو /observe لکھیں — میں سبق کے مشاہدے، تعمیری گفتگو کی تیاری، اور استاد کو رپورٹ بھیجنے میں مدد کروں گی۔',
    send_choice_body: 'آخری قدم: استاد کو اُن کی رپورٹ بھیجنا — سرکاری رپورٹ مع آپ کی گفتگو کے نکات۔ بھیجنے سے پہلے رپورٹ آپ کو دکھائی جائے گی۔ بھیجیں؟',
  ...
  en: {
    ...
    teacher_action_intro: "{school}\n\nAdd a teacher, remove one, or edit someone's details. Adding a teacher who is already at another school moves them here.",
...
const VISIT_CAPTURE_TEMPLATES = {
  ...
  ur: {
    withName: '🎙️ *{name}* کے سبق کا مشاہدہ۔ سبق شروع ہو تو ریکارڈ کر کے آڈیو مجھے بھیجیں — میں آپ کے لیے {fw} فارم تیار کر دوں گی۔',
