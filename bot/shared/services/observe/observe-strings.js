...
const STRINGS = {
  sw: {
    ...
    resume_retry_exhausted: 'Uchunguzi huu unasimama mara kwa mara — timu imejulishwa.',
  ...
  ur: {
    ...
    resume_retry_exhausted: 'یہ مشاہدہ بار بار رک رہا ہے — ٹیم کو اطلاع دے دی گئی ہے۔',
  ...
  en: {
    ...
    resume_retry_exhausted: 'This observation keeps stopping — the team has been told.',
