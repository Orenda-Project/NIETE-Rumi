...
/**
 * Why a repair declined to write. Defined HERE, and spread into the backfill's own skip vocabulary,
 * because this is the only place that can produce it — two copies of a reason string is how a run
 * summary starts counting a cause under two names.
 */
const REPAIR_SKIPPED = Object.freeze({ FIGURES_MISSING: 'figures_missing' });
...
module.exports = { repairRow, renderForRepair, segmentFor, REPAIR_SKIPPED };
