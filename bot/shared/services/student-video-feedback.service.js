/**
 * Student Video Feedback Service — bd-1598 follow-on
 *
...
// bd-2312: the optional `__vq` suffix marks a survey that covered the video AND
...
async function sendFeedbackPrompt({ videoId, userId, phone, context }) {
  ...
  // bd-2312: the survey asks about whatever the teacher actually RECEIVED.
...
async function handleFeedbackButton(buttonId, phone) {
  ...
  // bd-2312: link the row to the delivery and the quiz session so this feedback
