...
const COACHING_CARD_COPY = {
  ...
  ur: {
    ...
    // The subjunctive («عہد کریں؟»), never the masculine future «عہد کریں گے؟»:
    // the teacher's gender is unknown (operator, 24 Sep).
    commitPrompt: 'کیا اگلی کلاس میں یہ آزمانے کا عہد کریں؟',
