...
# The agents dir is TENANT LAYER: <repo>/<agents_dir> from tenants.yaml, never a sibling of this vendored file (bd-9157r).
...
def collect():
    rows = []
    # `<feature>-agent.md` or the historical `<prefix>-<feature>-agent.md`; the frontmatter's `feature:` is the name
...
def main():
    ...
    print("E2E feature execution order (source of truth: agent `order:` frontmatter)")
    for r in rows:
