...
# The repo under test is the one carrying tenants.yaml (CLAUDE_PROJECT_DIR or the cwd's ancestors) —
# never the engine's own directory, which holds no config/ or agents/ (bd-9157r).
QA = os.path.join(_tl.repo_root(), ".claude", "qa")
