#!/usr/bin/env python3
"""Stdlib assert tests for scripts/qa/ci_impact.py — the CI half of the QA pipeline.

ci_impact answers, for a commit range, the three questions a reviewer needs and
...
Run:  python3 scripts/qa/test_ci_impact.py
"""
import json
import os
import shutil
...
import ci_impact as ci  # noqa: E402
