#!/usr/bin/env python3
"""
Publish the Pakistan LP Flow JSON (FEAT-059) to Meta's WhatsApp Business Cloud API.

Mirrors scripts/publish-exam-generator-flow.py exactly; only FLOW_JSON path,
the flow name, and the default endpoint URI differ.
...
def main() -> int:
    ...
    if args.publish:
        ...
        print(f"   PAKISTAN_LP_FLOW_ID={flow_id}")
    else:
