...
describe('what must NOT change', () => {
  ...
  test('digits opening an Urdu line need nothing', () => {
    const tpl = UX_STRINGS.uptakeLineAchieved.ur;
    expect(resolveUx('uptakeLineAchieved', { language: 'ur', params: { count: '3/5' } }))
      .toBe(tpl.replace('{count}', '3/5'));
  });
